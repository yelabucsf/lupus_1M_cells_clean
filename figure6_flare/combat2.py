...
def combat(adata: AnnData, model=None, key: str = 'batch', inplace: bool = True):
    """
    ...
    sys.stderr.write("Adjusting data\n")
    bayesdata = s_data
